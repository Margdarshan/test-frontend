...
export const BlogListItem = ({ blog, blogImage, name, role, status, id, serialNo, refetchBlogsData, isLoading }) => {
    ...
    const handleCommentBlog = (id, name) => {
        ...
        window.scrollTo(0, 0); // Scroll to top when page changes
        navigate(`/admin/blog-comment`, { state: { id: id, name: name } });
    };
    ...
    const handleEditBlog = (blog) => {
        ...
        navigate('/admin/blog-edit', { state: { blog } });
    };
                ...
                <div className="flex items-center">
                    {
                        <button
                            ...
                            disabled={loading}
                            className={`status-toggle-button text-[10px] font-bold rounded-md text-white px-2 py-[3px] ${status
