...
const MentorComponent = () => {
  return (
    <div className="m-0 p-0 w-full overflow-x-hidden xl:px-24 bg-custom-gradient  max-w-full px-4 pt-12 pb-6 ">
      <div className="flex flex-col xl:flex-row mt-[40px] px-12 py-[4px] pt-8">
        <div className="xl:w-[50%] flex flex-col  justify-between">
          <div className="flex flex-col  space-y-4 xl:space-y-8 pt-12">
            <div className="text-start bg-[#4E18CD] bg-clip-text text-transparent text-[44px] xl:text-4xl font-medium flex flex-col space-y-4">
              <div className="text-center xl:text-start xl:w-[70%] leading-[60px]">
            ...
            <div>
              <p className="hidden xl:text-start xl:block text-[#454545]  font-inter text-lg xl:text-base">
                Master the IIT-JEE with comprehensive study materials,
                structured practice, and strategic revision to ace one of
                India's toughest engineering entrance exams
              </p>
            </div>
            <div className="flex justify-center xl:justify-start space-x-3">
